...
<p>We are creating a website which we would like to call the DiEM Caf&eacute;, a new sort of  public space which we hope will be used many times again in the future.</p>
...
<div class="jumbotron jumbotron-alt">
          <h2>Zoom</h2>
          <p>Zoom is a videoconferencing tool which will be used for the DiEM25 Caf&eacute;.
            You need to download it in advance and test it with a friend if possible, to avoid sound issues.</p>
...
<p>To become the host of a new meeting you need to click on &ldquo;sign in&rdquo; and generate an account
  ...
  Post the link to the meeting in the table tab so the other participants can click &ldquo;Join&rdquo;
...
<div class="jumbotron">
          <h2>Tables</h2>
          <p>A caf&eacute; table is a virtual place where the same question is discussed for several rounds by different groups of people. Only the host remains at the same table and the same language will be used for all rounds in a section.</p>
...
<p>If you are comfortable with more than one language, do not be shy, particularly if it is a less spoken one. Your language skills will help to create an interesting mix and make the DiEM Caf&eacute; a truly pan-European experience.</p>
<a href="#top">Back to top</a>
  </div>
  <a name="host"></a>
<div class="jumbotron jumbotron-alt">
    <h2>Hosting a table</h2>
<p>We need a tiny bit of help from you. The DiEM Caf&eacute; is a platform which depends on users to do part of the work. Very little, it is true, but essential. Each Caf&eacute; table consists of a browser tab from the DiEM Caf&eacute; site and a Zoom video conference screen. At each table one user will be the &ldquo;table host&rdquo;, who is responsible for creating the conference and posting the meeting ID in the table tab.
...
<div class="jumbotron">
    <h2>Etiquette</h2>
<p>The DiEM Caf&eacute; is, above all, about sharing without concerns our views with other DiEM25 members. A cooperative, constructive and relaxed atmosphere is what we should strive for. We propose a very basic <a href="#conduct">code of conduct</a>.</p>
<p>To use time most effectively we suggest the following order:</p>
<ol>
<li>A short introduction of all the table members.</li>
<li>The host will quickly run through the results from the previous session (2 Min. max.)</li>
